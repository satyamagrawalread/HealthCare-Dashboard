...
var _patientProfile = require("./patient-profile");
var _patientProfileDefault = parcelHelpers.interopDefault(_patientProfile);
function main() {
    (0, _patientProfileDefault.default)();
}
main();

},{"./patient-profile":"eLP10","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eLP10":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
async function populatePatientProfile() {
    ...
    if (patientInfo.gender === "Male") document.getElementById("gender-image").src = "/MaleIcon.svg";
    else document.getElementById("gender-image").src = "/FemaleIcon.svg";
